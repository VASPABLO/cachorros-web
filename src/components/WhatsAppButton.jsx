...
const WhatsAppButton = () => {
  const handleWhatsAppClick = () => {
    // Número de teléfono de WhatsApp (sin espacios ni símbolos, solo números con código de país)
    const phoneNumber = '50688826308';
    
    // Mensaje predefinido
    const message = 'Hola Cristian Quesada te saluda, gracias por escribir al proyecto Cachorros, ¿en qué podemos ayudar?';
